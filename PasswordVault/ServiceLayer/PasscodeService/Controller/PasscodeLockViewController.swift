...
open class PasscodeLockViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        case .faceID:
            touchIDButton?.setImage(UIImage(named: "passcodeFaceId"), for: .normal)
        case .touchID:
            touchIDButton?.setImage(UIImage(named: "passcodeTouchId"), for: .normal)
        default:
            return
        }
    ...
    internal func updatePasscodeView() {
        ...
        touchIDButton?.alpha = !passcodeLock.isTouchIDAllowed ? 0 : 1
    }
